...
class _SportsState extends State<Sports> {
  ...
  Widget build(BuildContext context) {
    SportsProvider provider = Provider.of<SportsProvider>(context);
    return Scaffold(
      appBar: AppBar(
        title: Text("Sports"),
      ),
            ...
            FloatingActionButton(
              ...
              onPressed: () {
                if(provider.newsToUpload.isEmpty){
                  ...
                  provider.uploadNews(provider.newsToUpload,provider.sportsLoc);
                  ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("News Uploaded successfully")));
                }
              },
              child: Text("Upload"),
            ),
